...
context master {
    ...
    entity businesspartner {
        key NODE_KEY: common.Guid @(title: '{i18n>SELLER_KEY}');
    ...
    entity product{
        ...
        TYPE_CODE: String(2);
        CATEGORY: String(32) @(title: '{i18n>PROD_CAT}');
...
context transaction {
    entity purchaseorder: common.Amount, cuid{
        ...
        PARTNER_GUID: Association to master.businesspartner @(title: '{i18n>SELLER_KEY}');
